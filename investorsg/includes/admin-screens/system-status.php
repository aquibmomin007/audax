		...
		<table class="widefat" cellspacing="0">
			...
			<tbody>
				...
				<?php if ( $show_400_migration && false === $force_hide_400_migration ) : ?>
					...
					<tr>
						<td data-export-label="4.0.0 Migration"><?php _e( 'Avada 4.0.0 Migration:', 'Avada' ); ?></td>
						<td class="help">&nbsp;</td>
						<td>
				...
				<?php if ( $show_500_migration ) : ?>
					...
					<tr>
						<td data-export-label="5.0.0 Migration"><?php _e( 'Avada 5.0.0 Migration:', 'Avada' ); ?></td>
						<td class="help">&nbsp;</td>
						<td>
				...
				<?php if ( false !== get_option( Avada::get_option_name() . '_500_backup', false ) || false !== get_option( 'scheduled_avada_fusionbuilder_migration_cleanups', false ) ) : ?>
					<tr>
						<td data-export-label="Remove 5.0.0 Migration Backups"><?php _e( 'Remove Avada 5.0.0 Migration Backups:', 'Avada' ); ?></td>
						<td class="help">&nbsp;</td>
						<td>
							<?php if ( isset( $_GET['cleanup-500-backups'] ) && '1' == $_GET['cleanup-500-backups'] ) : ?>
								...
								<?php esc_attr_e( 'The backups cleanup process has been scheduled and your the version 5.0.0 migration backups will be purged from your database.', 'Avada' ); ?>
							<?php else : ?>
