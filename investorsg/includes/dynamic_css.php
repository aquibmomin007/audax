	...
	if ( Avada()->settings->get( 'responsive' ) ) {
		...
		*/
		...
		if ( get_post_meta( $c_page_id, 'pyre_page_title_height', true ) ) {
			$ipad_portrait[ $ipad_portrait_media_query ]['#wrapper .fusion-page-title-bar']['height'] = Avada_Sanitize::size( get_post_meta( $c_page_id, 'pyre_page_title_height', true ) ) . ' !important';
		}
